...
def main(blastoutfile, gff_file, scovs_threshold, evalue_threshold, cddid_all_file, include_evalue, include_pident):
    ...
    with open(gff_file, 'r') as gff_fh:
        for i, row in enumerate(gff_fh):
            ...
            if include_rest:
                ...
                new_gff.append(extend_record(row, translated_blast_hits))
